...
import { fetchEvents, fetchComments, fetchPromotions, fetchPartners } from '../redux/ActionCreators';
    ...
    <ScrollView>
        <SafeAreaView
            ...
            <View style={styles.drawerHeader}>
                <View style={{ flex: 1 }}>
                    <Image source={require('./images/greenpea.jpeg')} style={styles.drawerImage} />
                </View>
                <View style={{ flex: 2 }}>
