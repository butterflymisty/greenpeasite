...
export const postFavorite = eventId => dispatch => {
    setTimeout(() => {
        dispatch(addFavorite(eventId));
    }, 2000);
};

export const addFavorite = eventId => ({
    type: ActionTypes.ADD_FAVORITE,
    payload: eventId
});

export const postComment = (eventId, rating, author, text) => dispatch => {
    const newComment = {
        eventId,
        rating,
        author,
...
export const deleteFavorite = eventId => ({
